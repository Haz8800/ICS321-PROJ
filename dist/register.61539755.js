...
},{"@supabase/supabase-js":"node_modules/@supabase/supabase-js/dist/module/index.js"}],"register.js":[function(require,module,exports) {
...
document.getElementById('registerForm').addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(event) {
    var formData, userData, _yield$supabase$from$, personData, personError, userId, _yield$supabase$from$2, passengerData, passengerError;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.prev = 3;
          _context.next = 6;
          return supabase.from('person').insert([{
        ...
        case 11:
          ...
          userId = personData[0].id; // Retrieve the user ID assigned by the database
          // Insert into 'passenger' table using retrieved 'userId'
          _context.next = 14;
          return supabase.from('passenger').insert([{
            userid: userId,
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([["browser.b6f259d9.js","node_modules/@supabase/node-fetch/browser.js"]]).then(function(){require("register.js");});
