...
},{"@supabase/supabase-js":"node_modules/@supabase/supabase-js/dist/module/index.js"}],"paymentv2.js":[function(require,module,exports) {
...
function init() {
  ...
  confirmButton.addEventListener('click', /*#__PURE__*/function () {
...
function loadTotalPrice() {
  return _loadTotalPrice.apply(this, arguments);
}
function _loadTotalPrice() {
  _loadTotalPrice = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var ticketId, _yield$supabase$from$, data, error, totalPriceDisplay;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ticketId = sessionStorage.getItem('reservedTicket');
          if (ticketId) {
            _context2.next = 4;
            break;
          }
        ...
        case 4:
          _context2.next = 6;
          return supabase.from('TotalPrice').select('TotalPrice').eq('Ticket_ID', ticketId).single();
        case 6:
          ...
          return _context2.abrupt("return");
        case 12:
          totalPriceDisplay = document.getElementById('totalPriceDisplay').querySelector('span');
...
function handleConfirmPayment() {
  return _handleConfirmPayment.apply(this, arguments);
}
function _handleConfirmPayment() {
  _handleConfirmPayment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    var creditCardNo, nameOnCard, expiryDate, cvv, userId, _yield$supabase$from$2, data, error;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          creditCardNo = document.getElementById('creditCardNumber').value;
          nameOnCard = document.getElementById('cardHolderName').value;
...
function handleCancelPayment() {
  return _handleCancelPayment.apply(this, arguments);
}
function _handleCancelPayment() {
  _handleCancelPayment = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
    var ticketId, _yield$supabase$from$3, error;
...
var b=require("node_modules/parcel-bundler/src/builtins/bundle-loader.js");b.register("js",require("node_modules/parcel-bundler/src/builtins/loaders/browser/js-loader.js"));b.load([["browser.b6f259d9.js","node_modules/@supabase/node-fetch/browser.js"]]).then(function(){require("paymentv2.js");});
},{}]},{},["node_modules/parcel-bundler/src/builtins/hmr-runtime.js",0], null)
//# sourceMappingURL=/paymentv2.858ec0a4.js.map